...
const translations = {
  sv: {
    ...
    'performance.metrics.risk.title': 'Debt-to-Equity Ratio',
    'performance.metrics.risk.description': 'proportion of debt financing to equity financing within the investment portfolio',
    ...
    'performance.metrics.aum.description': 'Planned listning of the B-shares on Nasdaq First North Stockholm',
