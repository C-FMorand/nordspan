...
const translations = {
  ...
  en: {
    ...
    // Performance Page
    'performance.title': 'Performance & Portfolio',
    'performance.subtitle': 'Transparent reporting of our investment results and portfolio development to ensure full transparency for our investors.',
    'performance.metrics.returns.title': 'Annual Returns',
    'performance.metrics.returns.description': 'Average annual return',
    'performance.metrics.risk.title': 'Volatility',
    'performance.metrics.risk.description': 'Standard deviation of returns',
    'performance.metrics.target.title': 'Target Achievement',
    'performance.metrics.target.description': 'Investment objectives met',
    'performance.metrics.aum.title': 'Assets Under Management',
    'performance.metrics.aum.description': 'Total managed capital',
    ...
    'performance.historical.title': 'Historical Performance',
