...
const translations = {
  sv: {
    ...
    'performance.subtitle': 'Cooach Equity är ett investeringsbolag med en hybrid investeringsmodell. Genom att kombinera säkerställda lån, aktieinvesteringar och projektfinansiering i fastigheter balanseras risk och avkastning.',
    'performance.metrics.returns.title': 'Target Årlig Avkastning',
    'performance.metrics.returns.description': 'Målsatt genomsnittlig årlig avkastning',
    'performance.metrics.risk.title': 'Direktutdelning',
    'performance.metrics.risk.description': 'Målsatt årlig utdelning från ränteintäkter',
    'performance.metrics.target.title': 'Target NAV 2029',
    'performance.metrics.target.description': 'Målsatt nettotillgångsvärde 2029',
    'performance.metrics.aum.title': 'Target IPO',
    'performance.metrics.aum.description': 'Planerad notering av B-aktierna på Nasdaq First North i H1 2030',
    'performance.portfolio.title': 'Kapitalallokering',
    'performance.portfolio.loans': 'Direktlån',
    'performance.portfolio.equity': 'Aktieinvesteringar',
    'performance.portfolio.projects': 'Projektfinansiering',
    ...
    'about.description': 'En hybrid investeringsmodell som balanserar förutsägbara kassaflöden från lån med långsiktig värdetillväxt från equity och projektfinansiering.',
    'about.loans.title': 'Direktlån',
    'about.loans.portfolio': '~45% av portföljen',
    'about.loans.description': 'Säkerställda direktlån syndikerade med strategiska partners. Målavkastning 15% årligen med säkerhet i realtillgångar och personliga garantier.',
    'about.equity.title': 'Aktieinvesteringar',
    'about.equity.portfolio': '~30% av portföljen',
    'about.equity.description': 'Selektiva minoritetsinvesteringar i tillväxtbolag, ofta via lån-till-equity-konverteringar för att minska totalförlustrisk. Målsatt 4x på 3-4 år.',
    'about.projects.title': 'Projektfinansiering',
    'about.projects.portfolio': '~25% av portföljen',
    'about.projects.description': 'Hybridfinansiering av fastighetsprojekt i Spanien med professionella utvecklare. Målsatt 1.5x på 12-24 månader.',
  ...
  en: {
    ...
    // Performance Page
    'performance.title': 'Targets & Portfolio',
    'performance.subtitle': 'Cooach Equity is an investment company with a hybrid investment model. By combining secured loans, equity investments and project financing in real estate, risk and return are balanced.',
    'performance.metrics.returns.title': 'Target Annual Return',
    'performance.metrics.returns.description': 'Targeted average annual return',
    'performance.metrics.risk.title': 'Direct Dividend',
    'performance.metrics.risk.description': 'Targeted annual dividend from interest income',
    'performance.metrics.target.title': 'Target NAV 2029',
    'performance.metrics.target.description': 'Targeted net asset value in 2029',
    'performance.metrics.aum.title': 'Target IPO',
    'performance.metrics.aum.description': 'Planned listing of B-shares on Nasdaq First North in H1 2030',
    'performance.portfolio.title': 'Capital Allocation',
    'performance.portfolio.loans': 'Direct Loans',
    'performance.portfolio.equity': 'Equity Investments',
    'performance.portfolio.projects': 'Project Financing',
    ...
    // About Section
    'about.title': 'Cooach Equity combines secured direct loans with',
    'about.title.highlight': 'strategic investments',
    'about.title.end': 'in growth companies',
    'about.description': 'A hybrid investment model that balances predictable cash flows from loans with long-term value growth from equity and project financing.',
    'about.loans.title': 'Direct Loans',
    'about.loans.portfolio': '~45% of portfolio',
    'about.loans.description': 'Secured direct loans syndicated with strategic partners. Target return 15% annually with collateral in real assets and personal guarantees.',
    'about.equity.title': 'Equity Investments',
    'about.equity.portfolio': '~30% of portfolio',
    'about.equity.description': 'Selective minority investments in growth companies, often via loan-to-equity conversions to reduce total loss risk. Target 4x in 3-4 years.',
    'about.projects.title': 'Project Financing',
    'about.projects.portfolio': '~25% of portfolio',
    'about.projects.description': 'Hybrid financing of real estate projects in Spain with professional developers. Target 1.5x in 12-24 months.',
  ...
  es: {
    ...
    // Performance Page
    'performance.title': 'Objetivos y Cartera',
    'performance.subtitle': 'Cooach Equity es una empresa de inversión con un modelo de inversión híbrido. Al combinar préstamos garantizados, inversiones de capital y financiación de proyectos inmobiliarios, se equilibra el riesgo y el retorno.',
    'performance.metrics.returns.title': 'Retorno Anual Objetivo',
    'performance.metrics.returns.description': 'Retorno anual promedio objetivo',
    'performance.metrics.risk.title': 'Dividendo Directo',
    'performance.metrics.risk.description': 'Dividendo anual objetivo de ingresos por intereses',
    'performance.metrics.target.title': 'NAV Objetivo 2029',
    'performance.metrics.target.description': 'Valor neto de activos objetivo en 2029',
    'performance.metrics.aum.title': 'IPO Objetivo',
    'performance.metrics.aum.description': 'Cotización planificada de acciones B en Nasdaq First North en H1 2030',
    'performance.portfolio.title': 'Asignación de Capital',
    'performance.portfolio.loans': 'Préstamos Directos',
    'performance.portfolio.equity': 'Inversiones de Capital',
    'performance.portfolio.projects': 'Financiación de Proyectos',
    'performance.historical.title': 'Desarrollo Histórico',
    ...
    'performance.highlights.diversification.description': 'Asignación equilibrada entre préstamos, capital y proyectos.',
    ...
    // About Section
    'about.title': 'Cooach Equity combina préstamos directos garantizados con',
    'about.title.highlight': 'inversiones estratégicas',
    'about.title.end': 'en empresas de crecimiento',
    'about.description': 'Un modelo de inversión híbrido que equilibra flujos de caja predecibles de préstamos con crecimiento de valor a largo plazo de capital y financiación de proyectos.',
    'about.loans.title': 'Préstamos Directos',
    'about.loans.portfolio': '~45% del portafolio',
    'about.loans.description': 'Préstamos directos garantizados sindicados con socios estratégicos. Retorno objetivo del 15% anual con garantía en activos reales y garantías personales.',
    'about.equity.title': 'Inversiones de Capital',
    'about.equity.portfolio': '~30% del portafolio',
    'about.equity.description': 'Inversiones minoritarias selectivas en empresas de crecimiento, a menudo mediante conversiones de préstamo a capital para reducir el riesgo de pérdida total. Objetivo 4x en 3-4 años.',
    'about.projects.title': 'Financiación de Proyectos',
    'about.projects.portfolio': '~25% del portafolio',
    'about.projects.description': 'Financiación híbrida de proyectos inmobiliarios en España con desarrolladores profesionales. Objetivo 1.5x en 12-24 meses.',
